# -*- coding: utf-8 -*-
"""5.mnist(rnn_conv2d).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/16hzHKDUpZEE6TyUAiWL2HNzDYvqLn-tg
"""

# CNN 예시 : LSTM과 2D convolution을 결합해서 mnist 이미지를 분석한다.
...
h_conv = Conv2D(filters=10, kernel_size=(10, 12), strides=1, padding = 'valid', activation='relu')(x_input_cnn)
